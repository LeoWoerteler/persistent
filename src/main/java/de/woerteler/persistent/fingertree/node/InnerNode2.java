 ...
 */
public class InnerNode2<N, E> extends InnerNode<N, E> {
  /** First sub-node. */
  public final Node<N, E> child0;
  /** Second sub-node. */
  public final Node<N, E> child1;
   ...
   */
  public InnerNode2(final Node<N, E> a, final Node<N, E> b) {
    child0 = a;
    l = a.size();
    child1 = b;
    r = l + b.size();
  ...
  public InnerNode<N, E> reverse() {
    return new InnerNode2<N, E>(child1, child0);
  }
  ...
  @Override
  public Node<Node<N, E>, E>[] remove(final Node<Node<N, E>, E> left,
  ...
  @Override
  public Node<N, E>[] remove(final long pos) {
    final Node<N, E>[] res =
        pos < l ? child0.remove(null, child1, pos) : child1.remove(child0, null, pos - l);
    @SuppressWarnings("unchecked")
    final Node<N, E>[] out = new Node[res[1] == null ? 1 : 2];
    System.arraycopy(res, pos < l ? 3 - out.length : 0, out, 0, out.length);
    return out;
  }
  ...
  protected NodeLike<Node<N, E>, E>[] concat(final NodeLike<Node<N, E>, E> other) {
    ...
    final NodeLike<N, E> sub = ((OneSubnode<N, E>) other).sub;
  ...
  @Override
  @SuppressWarnings("unchecked")
  public Node<N, E>[] copyChildren() {
    return new Node[] { child0, child1 };
  }

  @Override
  public InnerNode<N, E> replaceFirst(final Node<N, E> newFirst) {
    return newFirst == child0 ? this : new InnerNode2<>(newFirst, child1);
  }

  @Override
  public InnerNode<N, E> replaceLast(final Node<N, E> newLast) {
